    ...
    sealed class MIRcatSDK
    {
        ...
        */
        ...
        public static extern SDKConstant MIRcatSDK_GetSerialNumber(
            [In, Out, MarshalAs(UnmanagedType.LPStr, SizeParamIndex = 1)] ref string pszSerialNumber,
            byte bSize);
        ...
        */
        ...
        [DllImport("MIRcatSDK.dll", CallingConvention = CallingConvention.Cdecl)]
        [return: MarshalAs(UnmanagedType.U4)]
        public static extern SDKConstant MIRcatSDK_GetFactoryCrossover(
            byte chan,
            ref float wlCrossover_um);

        //MIRCAT_LIB uint32_t MIRcatSDK_GetUserCrossover(uint8_t chan, float* wlCrossover_um);
        [DllImport("MIRcatSDK.dll", CallingConvention = CallingConvention.Cdecl)]
        [return: MarshalAs(UnmanagedType.U4)]
        public static extern SDKConstant MIRcatSDK_GetUserCrossover(
            byte chan,
            ref float wlCrossover_um);
        ...
        [DllImport("MIRcatSDK.dll", CallingConvention = CallingConvention.Cdecl)]
        [return: MarshalAs(UnmanagedType.U4)]
        public static extern SDKConstant MIRcatSDK_SetUserCrossover(
            byte chan,
            ref float wlCrossover_um);
        ...
        */
        ...
        [DllImport("MIRcatSDK.dll", CallingConvention = CallingConvention.Cdecl)]
        [return: MarshalAs(UnmanagedType.U4)]
        public static extern SDKConstant MIRcatSDK_ConvertCountsToMilliRadians(
            Int32 counts,
            ref float milliRadians);

        //MIRCAT_LIB uint32_t MIRcatSDK_ConvertMilliRadiansToCounts(float milliRadians, int32_t* counts);
        [DllImport("MIRcatSDK.dll", CallingConvention = CallingConvention.Cdecl)]
        [return: MarshalAs(UnmanagedType.U4)]
        public static extern SDKConstant MIRcatSDK_ConvertMilliRadiansToCounts(
            float milliRadians,
            ref Int32 counts);
